...
-- 正在导出表  countdownapp.countdowns 的数据：~4 rows (大约)
...
-- 正在导出表  countdownapp.users 的数据：~0 rows (大约)
INSERT INTO `users` (`id`, `nickname`, `avatar`, `created_at`, `updated_at`) VALUES
	(1, '张三', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=200&h=200&fit=crop', '2025-11-27 04:38:15', '2025-11-27 04:38:15');
